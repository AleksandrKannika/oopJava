...
import homework.hw4.chars.Vector2;
...
public class ConsoleView {
    ...
    public static void view() {
        ...
        charInfo(Main.TeamSize);// боковая информация
    ...
    private static void charInfo (int i){
        String str1 = AnsiColors.ANSI_BLUE + Main.team1.get(--i).getManType() + AnsiColors.ANSI_RESET
                    + " HP: " + Main.team1.get(i).getHp()
                    + " " + Main.team1.get(i).getStatus();
        String str2 = 
                    AnsiColors.ANSI_CYAN + Main.team2.get(i).getManType() + AnsiColors.ANSI_RESET
                    + " HP: " + Main.team2.get(i).getHp()
                    + " " + Main.team2.get(i).getStatus();
